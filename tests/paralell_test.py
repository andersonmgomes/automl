...
class ParalellTest:
    def __init__(self):
        print('init')
        #self.p_feateng = Pool()
        self.p_feateng = Pool(processes=4)
        self.result = self.p_feateng.starmap_async(self.features_eng, [(19, 19), (13, 19), (1, 5), (3, 4), (19, 19), (13, 19), (1, 5), (3, 4)])
        self.ret = None
        print('init end...')
